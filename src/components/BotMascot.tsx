...
export const BotMascot: React.FC<BotMascotProps> = ({
  ...
  return (
    <div
      ...
      title={`Bạn ơi, mình nói nè (${getMoodEmoji()})`}
    >
      <div className="w-full h-full bg-white rounded-[14px] flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          {mood === 'empathy' && (
            <>
              {/* Big empathetic eyes with sparkle */}
        ...
        <span className="absolute -bottom-1 -right-1 text-[11px] leading-none bg-white/95 rounded-full px-0.5 py-0.5 shadow-xs border border-rose-100">
          {getMoodEmoji()}
        </span>
      </div>
    </div>
